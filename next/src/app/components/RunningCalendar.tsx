...
export default function RunningCalendar({ records, onDateClick }: RunningCalendarProps) {
        ...
        {calendarDays.map((date, index) => {
          ...
          return (
            <div
              ...
              className={`
                relative h-12 flex items-center justify-center text-sm cursor-pointer transition-all duration-200 rounded-lg
                ...
                ${!hasRun && isCurrentMonth ? 'hover:bg-gray-100' : ''}
